...
<body style="background-color: rgb(241, 249, 255)">
    <cfquery datasource="TestMySql" name="getAllGeography">
    ...
    <div class="container d-flex flex-column">
        <h2 class="titleText">Demographics for Influenza Vaccination Coverage</h2>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        ...
        <div class="modal-body bg-light">
            ...
            <form id="coverage_form">
                ...
                <cfquery datasource="TestMySql" name="getAllVaccineType">
                    SELECT * 
                    FROM VaccineType
                </cfquery>
                ...
                <cfquery datasource="TestMySql" name="getAllSeasons">
                ...
                <select class="form-select" name="geography_type" id="geography_type" onchange="updateGeography()">
                    <option selected value="4">States/Local Areas</option>
                    <option value="5">HHS Regions/National</option>
                </select>
                <cfquery datasource="TestMySql" name="getAllGeography">
                    SELECT * 
                    FROM Geography
                    WHERE geographyTypeID = 4
                    ORDER BY Name
                </cfquery>
                <select class="form-select my-2" name="geography" id="geography">
                    <cfoutput query="getAllGeography">
                        <cfif getAllGeography.ID EQ 131>
                ...
                <cfquery datasource="TestMySql" name="getAllAgeGroup">
                    SELECT * 
                    FROM Dimension
                    WHERE DimensionTypeID = 4
                    ORDER BY Name    
                </cfquery>
                ...
                <cfquery datasource="TestMySql" name="getAllRace_ethn">
                    SELECT * 
                    FROM Dimension
                    WHERE DimensionTypeID = 5
                    ORDER BY Name  
                </cfquery>
                <div>
                    ...
                    <div class="row">
                        <cfoutput query="getAllRace_ethn">
                            <cfif getAllRace_ethn.ID EQ 42 || getAllRace_ethn.ID EQ 35>
                                <div class="d-flex flex-column justify-content-center align-items-center col-6 col-lg-3 py-2">
